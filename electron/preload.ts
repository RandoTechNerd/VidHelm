...
contextBridge.exposeInMainWorld('ipcRenderer', {
  ...
  makeProxy: (data: { filePath: string; info: any }) => ipcRenderer.invoke('make-proxy', data),
  sampleFrames: (data: { filePath: string; count?: number; sourceStart?: number; duration?: number }) => ipcRenderer.invoke('sample-frames', data),
  scanBroll: (data: { folder: string; refresh?: boolean }) => ipcRenderer.invoke('scan-broll', data),
