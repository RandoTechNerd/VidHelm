...
contextBridge.exposeInMainWorld('ipcRenderer', {
  ...
  normalizeAlphaMedia: (data: { filePath: string; fallbackFps?: number }) => ipcRenderer.invoke('normalize-alpha-media', data),
  ...
  exportVideo: (data: { clips: any[], texts: any[], brand: any, audio: any, outputPath: string, settings: any }) => ipcRenderer.invoke('export-video', data) as Promise<{ success: boolean; outputPath: string; format: string; alpha: boolean; frames?: number }>,
